        ...
        <section className="group">
            <div className={`flex flex-col md:flex-row items-center gap-8 rounded-3xl overflow-hidden ${isDarkMode ? 'bg-slate-900' : 'bg-white shadow-xl'}`}>
                <div className="flex-1 p-8 md:p-12">
                    ...
                    <button className={`px-8 py-4 rounded-xl text-white font-bold flex items-center gap-2 transition-transform hover:scale-105 active:scale-95 bg-[var(--hero-primary-color)] `} >
