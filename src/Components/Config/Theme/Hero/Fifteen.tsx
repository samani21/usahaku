        ...
        <section>
            ...
            <div className={`grid md:grid-cols-2 bg-[var(--hero-primary-color)] text-white rounded-3xl overflow-hidden min-h-[500px]`}>
                <div className="p-12 flex flex-col justify-center items-start text-left order-2 md:order-1">
                    ...
                    <button className={`px-10 py-4 bg-white text-[var(--hero-primary-color)]  hover:bg-[var(--hero-secondary-color)]  font-bold uppercase tracking-widest text-xstransition-colors`}>Lihat Koleksi</button>
                </div>
