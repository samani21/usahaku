...
const Six = ({ totalCart, summary, isBuild }: Props) => {
    ...
    return (
        <div className="space-y-4">
            <div className="sticky bottom-6 mx-auto w-fit bg-white/40 backdrop-blur-xl border border-white/50 p-2 rounded-full shadow-xl flex items-center gap-4">
                ...
                <button onClick={() => !isBuild && router.push('/checkout')} className="bg-slate-900 text-white pr-6 pl-4 py-2 rounded-full flex items-center gap-2 text-sm font-medium">
