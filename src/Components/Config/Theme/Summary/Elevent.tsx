    ...
    return (
        <div className="space-y-4">
            <div className="sticky bottom-6 px-6">
                <HandleCheckout isBuild={isBuild} className="w-full bg-[var(--summary-primary-color)] text-[var(--summary-secondary-color)] p-4 rounded-full shadow-xl shadow-[var(--summary-primary-color)] flex justify-between items-center px-8">
