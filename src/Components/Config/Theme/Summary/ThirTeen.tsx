    ...
    return (
        <div className="space-y-4">
            <div className="sticky bottom-10 flex justify-center">
                <HandleCheckout isBuild={isBuild} className={`cursor-pointer ${isDarkMode ? "bg-slate-800  border-slate-600" : "bg-white  border-slate-100"} p-2 rounded-full shadow-2xl border flex items-center gap-3 pr-6`}>
