    ...
    return (
        <div className="space-y-4">
            <div className={`sticky bottom-0  p-4 border-t-2 ${isDarkMode ? "bg-gray-700" : "bg-white"} border-[var(--summary-primary-color)] flex justify-between items-center`}>
                ...
                <HandleCheckout isBuild={isBuild} className={`bg-[var(--summary-primary-color)]/80 text-[var(--summary-secondary-color)] px-6 py-2 rounded-md font-black uppercase text-xs italic`}>Checkout</HandleCheckout>
            </div>
        </div>
    )
}
