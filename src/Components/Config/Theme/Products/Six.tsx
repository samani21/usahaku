                ...
                return (
                    ...
                    >
                        ...
                        <div className={`relative h-full border-4 border-black p-4 flex flex-col transition-transform group-hover:-translate-x-1 group-hover:-translate-y-1 ${isDarkMode ? 'bg-zinc-800' : 'bg-white'}`}>
                            ...
                            {label && (
                                <div className="absolute -top-4 -left-4 z-1 bg-red-500 text-white text-xs font-black px-4 py-2 border-4 border-black rotate-[-5deg]">
                                    {label}
                                </div>
                            )}
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between items-end pt-2 border-t-2 border-black/10">
                                    ...
                                    <div className="w-10 h-10 border-4 border-black flex items-center justify-center bg-black text-white group-hover:bg-red-500 transition-colors">
