    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 h-full'>
                ...
                return (
                    ...
                    >
                        ...
                        <div className="w-full relative overflow-hidden mb-6">
                            <img
                                src={p?.image}
                                className="w-full aspect-[16/8] object-cover grayscale group-hover:grayscale-0 group-hover:scale-110 transition-all duration-700"
                                alt={p.name}
                            />
                            {label && (
                                <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity bg-black/40">
                                    <span className="bg-white text-black font-black px-4 py-2 text-xs uppercase tracking-widest italic">
                                        Potongan {formatIDR(p?.discount_price ?? 0)}
                                    </span>
                                </div>
                            )}
                        </div>

                        <div className="w-full flex justify-between items-center font-mono font-black text-sm uppercase tracking-tighter">
                            {p?.category && (
            ...
            <AlertWrapper activeAlert={activeAlert} position="top-center">
                <div className={`${isDarkMode ? "bg-slate-900 border-slate-800 text-white" : "text-slate-900 bg-white border-slate-200"} px-4 py-2 rounded-full shadow-lg flex items-center gap-3 border`}>
