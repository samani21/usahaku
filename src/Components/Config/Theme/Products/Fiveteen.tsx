...
const Fiveteen = ({ products, isDarkMode, handleCart }: Props) => {
    ...
    return (
        <div id="product-section" className='grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 h-full'>
            {products?.map((p, i) => (
                <div onClick={() => setProduct(p)} key={i} className="group cursor-pointer hover:bg-[var(--product-primary-color)]/5 rounded-md flex flex-col items-center justify-center p-4">
                    ...
                    <div className="text-center">
                        ...
                        <h3 className="text-sm sm:text-md font-black uppercase italic">{p?.name}</h3>
                    ...
                    <div className="max-w-4xl w-full flex flex-col md:flex-row items-center gap-12">
                        ...
                        <div className="md:w-1/2 space-y-8">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <button disabled={disableButton} onClick={() => addCart()} className={`w-full disabled:bg-gray-600  py-6 bg-[var(--product-primary-color)] text-white rounded-[3rem] font-black uppercase tracking-[0.2em] shadow-2xl flex items-center justify-center gap-4`}>
