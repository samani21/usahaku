...
const App = () => {
    ...
    const themes = [
        ...
        { id: 4, name: 'Fashion', icon: <Shirt className="w-8 h-8" />, description: 'Pakaian tren masa kini', image: "", mode: "" },
        { id: 5, name: 'Coffee Shop', icon: <Coffee className="w-8 h-8" />, description: 'Ruang kopi ternyaman', image: "", mode: "" },
        { id: 6, name: 'Bengkel', icon: <Wrench className="w-8 h-8" />, description: 'Servis kendaraan ahli', image: "", mode: "" },
        { id: 7, name: 'Jasa Jahit', icon: <Scissors className="w-8 h-8" />, description: 'Custom pakaian & reparasi', image: "", mode: "" },
        { id: 8, name: 'Sembako', icon: <Store className="w-8 h-8" />, description: 'Bahan pokok murah', image: "", mode: "" },
        { id: 9, name: 'Bakery', icon: <Croissant className="w-8 h-8" />, description: 'Roti & kue fresh', image: "", mode: "" },
        { id: 10, name: 'Warung Makan', icon: <Utensils className="w-8 h-8" />, description: 'Masakan rumah nikmat', image: "", mode: "" },
        { id: 11, name: 'Studio Foto', icon: <Camera className="w-8 h-8" />, description: 'Abadikan momen indah', image: "", mode: "" },
        { id: 12, name: 'Barbershop', icon: <UserRound className="w-8 h-8" />, description: 'Gaya rambut pria modern', image: "", mode: "" },
        ...
        <div className="min-h-screen bg-white font-sans text-slate-800">
            ...
            <main className="max-w-7xl mx-auto px-6 pt-20 pb-24 text-center">
                ...
                {filteredThemes.length === 0 && (
                    <div className="py-20">
                        <p className="text-slate-400 text-xl italic">Maaf, tema usaha belum tersedia.</p>
                    </div>
                )}

                {/* Pricing Anchor */}
                <div className="mt-32">
                    <h2 className="text-slate-700 font-bold text-3xl tracking-widest uppercase">
                        PAKET & HARGA
                    </h2>
                </div>
            </main>

            <footer className="py-12 border-t border-gray-100 text-center text-slate-400 text-sm">
                &copy; 2024 UsahaKu Go Digital. Membantu UMKM Indonesia naik kelas.
            </footer>
        </div>
    );
};
