        ...
        <div className={`flex flex-col items-center justify-center ${isDarkTheme ? 'bg-slate-950 text-white' : 'bg-slate-50 text-slate-900'}`}>
            <div className='max-w-7xl w-full space-y-6 relative'>
                ...
                <div className={`mt-12 space-y-6 ${header?.layout_header === 3 ? "pt-26" : 'pt-16'} pb-18 px-2 `}>
                    ...
                    {hero && (
                        <div className={`${hero?.mode == 'dark' ? 'text-white' : 'text-slate-900'}`}>
                            <HeroConfig
                                theme={hero?.layout_hero}
                                isDarkMode={isDarkTheme || hero?.mode == 'dark'}
                    ...
                    )}
                    {
                        ...
                        <CategorieConfig
                            ...
                            isDarkMode={isDarkTheme || category?.mode == 'dark'} />
                    }
                    {
                        product && products &&
                        <ProductConfig
                            ...
                            products={products}
                            isDarkMode={isDarkTheme || product?.mode == 'dark'} />
                    }
                        ...
                        <div className='max-w-7xl w-full'>
                            {
                                ...
                                <SummaryConfig
                                    ...
                                    isDarkMode={isDarkTheme || summary?.mode == 'dark'}
                                    totalCart={3}
                                    summary={100000}
                                    isBuild={true} />
                            }
